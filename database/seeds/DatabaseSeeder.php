...
class DatabaseSeeder extends Seeder
{
    ...
    private $arrayPeliculas = array(
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/embed/auCgsj0MV-M'
		),
		array(
			...
			'trailer' => 'https://www.youtube.com/embed/4u87tmlj4oE'
		),
		array(
			'title' => 'El golpe',
			'year' => '1973',
		...
		array(
			...
			'trailer' => 'https://www.youtube.com/embed/JYeUVn0gXos'
		)
	);
	...
	public function seedUsers(){
		...
		$user1 = new User;
    	$user1->name = 'dylan';
    	$user1->email = 'dylan@dylan.com';
    	$user1->password = bcrypt('dylan');
    	$user1->save();
	}
	...
	public function seedCategory(){
    	...
    	$category1->title = 'Infantil';
    	$category1->description = 'Pelicules per el mes petits';
		$category1->adult = false;
		$category1->save();

		$category2 = new Category;
    	$category2->title = 'Drama';
    	$category2->description = 'Pelicules per plorar';
		$category2->adult = false;
		$category2->save();

		$category3 = new Category;
    	$category3->title = 'Comèdia';
    	$category3->description = 'Pelicules per riure';
		$category3->adult = true;
		$category3->save();

		$category4 = new Category;
    	$category4->title = 'Thriller';
    	$category4->description = 'Pelicules emocionants';
		$category4->adult = false;
		$category4->save();
